...
const ProductList = () => {
  ...
  const getCcList = () => {
    ...
    postMethod(config.getCProduct, payloaddata)
      .then((res) => {
  ...
  return (
    <div style={{ margin: "10%" }}>
      ...
      <Datatable url={config.getProduct} handleOptions={handleOptions} flowEvent="ProductEvent" flow="MasterDataFlow" header_data={header_data} onCreateClick={handleCreateClick} />
