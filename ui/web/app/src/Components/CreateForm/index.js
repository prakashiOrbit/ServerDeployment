                                            ...
                                            this.state.searchBar.division.formelements.map((item, index) => {
                                                return (
                                                    <div key={index} style={{ width: 200, margin: 5 }}>
                                                        {
                                                            item.control === 'select' ? (
                                                                <SelectClass formDetails={item} onChange={this.onChangeSearch} inputDetails={this.state.inputDetails} editFlag={this.props.aev} />)
                                                                : item.control === 'textbox' ? (<TextFieldClass formDetails={item} onChange={this.onChangeSearch} inputDetails={this.state.inputDetails} editFlag={this.props.aev} formErrors={this.state.formErrors} />)
                                                                    : item.control === 'date' ? (<DateClass formDetails={item} onChange={this.onChangeSearch} inputDetails={this.state.inputDetails} editFlag={this.props.aev} />)
                                                                        : (<>No Data Box</>)
