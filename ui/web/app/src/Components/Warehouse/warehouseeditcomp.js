    ...
    return (
        <div style={{ margin: "12%" }}>
            <Grid container spacing={8}>
                ...
                <Grid>
                    <Button style={{ marginRight: "60px", marginTop: "80px" }} variant="contained" name="submit" onClick={onClick}>{type == "edit" ? "Save" : "Add"}</Button>
                    <Button style={{ marginRight: "60px", marginTop: "80px" }} variant="contained" onClick={onClick} name="cancel">Cancel</Button>
