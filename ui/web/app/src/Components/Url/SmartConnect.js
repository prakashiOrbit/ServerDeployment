...
export default class SmartConnect extends Component {
    ...
    handleSearch = (url, searchString) => {
        ...
        this.postMethod({"FlowAdmin": {"___smart_action___": "lookup","___smart_value___": this.state.flow},"searchString": searchString},
        'http://', 'localhost:9082/', 'apptest/', 'FarmerFlow', url);
    }

    handleEdit = (url, data) => {
        console.log(url, data, "from handle Edit click");
        this.postMethod(...data,{"FlowAdmin": {"___smart_action___": "lookup","___smart_value___": "FarmerFlow"}},
        'http://', 'localhost:9082/', 'apptest/', 'FarmerFlow', url);
    }
