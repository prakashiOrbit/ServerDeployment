...
public class Validator {
	private static String name_regex = "^[^0-9]+$";
	private static String contact_regex = "(0/91)?[7-9][0-9]{9}";
	private static String street_regex = "^[a-zA-Z0-9][a-zA-Z0-9\\\\s]*$";
	private static String city_regex = "[a-zA-Z ]+$";
	private static String state_regex = "[a-zA-Z ]+$";
	...
	private static String payeename_regex = "^[^0-9]+$";
	...
	public static boolean isValidPayeeName(String payeename) {
		return matchRegex(name_regex, payeename);
	}
	
	public static boolean isValidStreet(String street) {
		return matchRegex(name_regex, street);
	}
